...
class DeepseekTranslation:
    """DeepSeek API translation with the same interface as GoogleTranslation."""

    def __init__(self, model="deepseek-chat", temperature=1.3):
    ...
    def translate_text(self, text, source_lang, target_lang):
        try:
            ...
            print(f"⚠️ DeepSeek translation failed {source_lang}→{target_lang}: {e}")
            return None
...
def main(args):
    ...
    print(f"Translating '{translation_part}' from {src_lang} to {tgt_lang} (DeepSeek)")
